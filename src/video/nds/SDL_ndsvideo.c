...
static SDL_VideoDevice *NDS_CreateDevice(void)
{
    ...
    device->CreateWindowFramebuffer = SDL_NDS_CreateWindowFramebuffer;
    device->UpdateWindowFramebuffer = SDL_NDS_UpdateWindowFramebuffer;
    device->DestroyWindowFramebuffer = SDL_NDS_DestroyWindowFramebuffer;
